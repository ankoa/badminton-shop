...
CREATE TABLE `user` (
  ...
  VALUES 
  (1, 'user1', 'password1', CURRENT_TIMESTAMP(), 1, 'User One', 'user1@example.com', '123456789', 0, 'regular', '1'),
  (2, 'user2', 'password2', CURRENT_TIMESTAMP(), 1, 'User Two', 'user2@example.com', '987654321', 0, 'regular', '1'),
  (3, 'user3', 'password3', CURRENT_TIMESTAMP(), 1, 'User Three', 'user3@example.com', '555555555', 0, 'regular', '1'),
  (4, 'user4', 'password4', CURRENT_TIMESTAMP(), 1, 'User Four', 'user4@example.com', '111111111', 0, 'regular', '1'),
  (5, 'user5', 'password5', CURRENT_TIMESTAMP(), 1, 'User Five', 'user5@example.com', '222222222', 0, 'regular', '1');
