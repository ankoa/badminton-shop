window.onload = function() {
    ...
    if (window.location.pathname === '/badminton-main/Controllers/index.php' && urlParams.get('control') === 'checkDonHang') {
    ...
    if (window.location.pathname === '/badminton-main/Controllers/index.php' && urlParams.get('control') === 'DetailOrder') {
        listDelete();
        renderReOrder();
    }
};
