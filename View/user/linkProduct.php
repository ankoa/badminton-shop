...
<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
        ...
        <a itemprop="item" href="index.php?control=ProductCategory&id=<?php echo $id; ?>" title="<?php echo $catalog->getName(); ?>"><span itemprop="name"><?php echo $catalog->getName(); ?></span></a>
