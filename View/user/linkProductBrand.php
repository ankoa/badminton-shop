...
$catalog = $modelCatalog->getCatalogByID($id);
?>
<li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">

        <a itemprop="item" href="index.php?control=ProductCategory&id=<?php echo $id; ?>&brandID=<?php echo $brandid; ?>" title="<?php echo $brand->getName(); ?> <?php echo $catalog->getName(); ?>"><span itemprop="name"><?php echo $brand->getName(); ?> <?php echo $catalog->getName(); ?></span></a>
